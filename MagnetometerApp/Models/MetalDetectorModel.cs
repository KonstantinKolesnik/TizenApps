...
namespace MagnetometerApp.Models
{
    ...
    public class MetalDetectorModel
    {
        #region fields
        /// <summary>
        /// Magnometer service which allows to obtain the magnetometer data.
        /// </summary>
        ...
        {
            return (int)Math.Ceiling(value > MAX_SIGNAL_STRENGTH ? max : Math.Log(value) / Math.Log(MAX_SIGNAL_STRENGTH) * max);
        }
